...
export default function LoginScreen() {
  ...
  const { signInWithGoogle, signInWithApple, signInWithEmail, isLoading, error, clearError } = useAuth();

  // Animated glow for the logo
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100).duration(600)} style={styles.logoSection}>
          <Animated.View style={[styles.logoCircle, logoGlowStyle]}>
            <MaterialCommunityIcons name="camera-iris" size={48} color={Colors.electricBlue} />
          </Animated.View>
          <Text style={styles.appTitle}>VIRTUCAM</Text>
          <Text style={styles.appTagline}>Virtual Camera Engine</Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(600)}>
          <View style={styles.glassCard}>
            <View style={styles.glassInner}>
              ...
              <Text style={styles.cardSubtitle}>Sign in to your command center</Text>
        ...
        {/* Version Badge */}
        <Animated.View entering={FadeIn.delay(600).duration(500)} style={styles.versionContainer}>
          <View style={styles.versionBadge}>
            <View style={styles.versionDot} />
            <Text style={styles.versionText}>SECURE CHANNEL v1.0</Text>
          </View>
        </Animated.View>
      </ScrollView>
    </KeyboardAvoidingView>
